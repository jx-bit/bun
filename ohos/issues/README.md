...
| [#79](https://github.com/jx-bit/bun/pull/79) | [pr79-p3-release-docs-seeding.md](pr79-p3-release-docs-seeding.md)（P3——发布文档自动占位：release-docs 专用分支（三方案权衡记录）+ 播种步骤（幂等 + 5xx 重试）+ body 瘦身对齐官方模式 + 占位纳入发布门禁；实弹三路径验证） | 🔄 OPEN |
